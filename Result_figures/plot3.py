...
clc_data = df[df['workflow'] == 'CLC']    # Include all CLC variants (both annotated and low)
...
# Customize
plt.title(
    f'Variants per Sample from GATK (ALL) and CLC (ALL)\n'
...
plt.savefig('/mnt/scratch/nazilak/Results/Number_of_variants/Default/plot3_GATK(PASS)_CLC(ALL).png')
