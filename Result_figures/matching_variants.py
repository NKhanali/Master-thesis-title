...
log_file_path = "/mnt/scratch/nazilak/Results/Matching_variants/matching_variants_log.txt"
...
with open(log_file_path, "w") as log_file:
    with redirect_stdout(log_file):
        ...
        plt.title("Stacked Bar Plot of Matching and Unique Variants Per Sample (GATK (PASS) CLC (ANNOTATED))")
        ...
        plot_path = "/mnt/scratch/nazilak/Results/Matching_variants/stacked_matching_variants_per_sample.png"
        ...
        csv_path = "/mnt/scratch/nazilak/Results/Matching_variants/matching_variants_per_sample.csv"
        ...
        plt.title("Venn Diagram: GATK (PASS) vs CLC Variants (Annotated)")

        venn_plot_path = "/mnt/scratch/nazilak/Results/Matching_variants/venn_diagram_gatk_clc.png"
        ...
        df_matching = pd.read_csv("/mnt/scratch/nazilak/Results/Matching_variants/matching_variants_per_sample.csv")
        ...
        plt.title("Common Variants Between GATK (PASS) and CLC (ANNOTATED) Per Sample")
        plt.xticks(samples, rotation=90)
        plt.tight_layout()

        # Save the bar plot for common variants
        common_variants_plot_path = "/mnt/scratch/nazilak/Results/Matching_variants/common_variants_per_sample.png"
