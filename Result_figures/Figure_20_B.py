...
df1_gatk = df1[(df1["workflow"] == "GATK")& (df1['filter_status'] == 'PASS')]
df2_gatk = df2[(df2["workflow"] == "GATK")& (df2['filter_status'] == 'PASS') ]
...
plt.title("PASS GATK Variant Calls (Including Duplicates)")
plt.tight_layout()
plt.savefig("/mnt/scratch/nazilak/Results/PON_vs_HP_PASS.png")
plt.show()
